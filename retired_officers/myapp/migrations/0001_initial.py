    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.activity')),
                ('label', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.scorelabel')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('activity', models.ManyToManyField(through='myapp.Score', to='myapp.activity')),
                ('graduated_school', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='myapp.school')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
